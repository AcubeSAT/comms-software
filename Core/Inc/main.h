...
#define P5V_FPGA_PG_GPIO_Port GPIOE
#define P5V_RF_PG_Pin GPIO_PIN_10
#define P5V_RF_PG_GPIO_Port GPIOE
#define P3V3_RF_PG_Pin GPIO_PIN_11
#define P3V3_RF_PG_GPIO_Port GPIOE
#define P5V_FPGA_EN_Pin GPIO_PIN_12
#define P5V_FPGA_EN_GPIO_Port GPIOE
