...
void ParameterService::initializeParameterMap() {
    parameters = {{PlatformParameters::ReportParametersUnusedStack,     PlatformParameters::reportParametersUnusedStack},
                  ...
                  {PlatformParameters::COMMSPCBTemperatureUHF,          PlatformParameters::commsPCBTemperatureUHF},
                  {PlatformParameters::COMMSPCBTemperatureSBAND,        PlatformParameters::commsPCBTemperatureSBAND},
                  {PlatformParameters::COMMSPCBTemperatureMCU,          PlatformParameters::commsPCBTemperatureMCU},
